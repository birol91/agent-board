...
import type { WindowFrame } from "@agentdeck/shared-types";
import type { AgentActivityEntry } from "./store.js";
...
export function AgentWindow({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-auto bg-stone-950 px-3 py-2 font-mono text-[11px] text-stone-100">
        {activity.length === 0 ? (
